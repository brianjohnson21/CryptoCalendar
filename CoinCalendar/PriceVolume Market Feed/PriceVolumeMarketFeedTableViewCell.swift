//
//  PriceVolumeMarketFeedTableViewCell.swift
//  CoinCalendar
//
...
class PriceVolumeMarketFeedTableViewCell: UITableViewCell {
...
extension PriceVolumeMarketFeedTableViewCell {
    func setupViews() {
        ...
        coinRankContainer.widthAnchor.constraint(equalToConstant: 93).isActive = true
        ...
        priceContainer.widthAnchor.constraint(equalToConstant: 80).isActive = true
