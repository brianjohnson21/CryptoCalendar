//
//  WatchlistCoinOptionsViewController+Views.swift
//  CoinCalendar
//
...
extension WatchlistCoinOptionsViewController {
    ...
    func setupViews() {
        ...
        mainHeight = mainContainer.heightAnchor.constraint(equalToConstant: 400) //540
        ...
        watchlistOption.optionButton.addTarget(self, action: #selector(tappedRemoveFromWatchlist), for: .touchUpInside)
