//
//  TimePickerViewController+Views.swift
//  CoinCalendar
//
...
extension TimePickerViewController {
    ...
    func setupViews() {
        ...
        wrapper.transform = CGAffineTransform(translationX: 0, y: view.frame.height)
...
extension TimePickerViewController: UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    func pickerView(_ pickerView: UIPickerView, attributedTitleForRow row: Int, forComponent component: Int) -> NSAttributedString? {
        let attributedString = NSAttributedString(string: duration[row], attributes: [NSAttributedString.Key.foregroundColor : UIColor.keyEventHeadlineColorModeLight])
