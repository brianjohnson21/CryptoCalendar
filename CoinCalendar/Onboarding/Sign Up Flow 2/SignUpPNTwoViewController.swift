//
//  SignUpPNTwoViewController.swift
//  CoinCalendar
//
...
protocol SignUpPNTwoViewControllerDelegate: class {
    func hideOldViews()
}

class SignUpPNTwoViewController: UIViewController {

    weak var delegate: SignUpPNTwoViewControllerDelegate?
    ...
    var getStartedHeight: NSLayoutConstraint!
    ...
    var continueTrailing: NSLayoutConstraint!
...
extension SignUpPNTwoViewController {
    ...
    @objc func animateViewsIn() {
        ...
        getStartedHeight.constant = 63
        
        continueBottom.constant = conBottom
        continueTrailing.constant = -18
        continueWidth.constant = view.frame.width - 36
        continueHeight.constant = 63
    ...
    @objc func goToPickCrypto() {
        ...
        shrinkAnimation(viewToAnimate: emailContainer, delay: 0.1)
        //shrinkAnimation(viewToAnimate: nameLabel, delay: 0.1)
        //shrinkAnimation(viewToAnimate: photoDetailLabel, delay: 0.25)
        shrinkAnimation(viewToAnimate: pageControl, delay: 0.25)
...
extension SignUpPNTwoViewController: CircleCropViewControllerDelegate {
    func goToStepThree() {
...
extension SignUpPNTwoViewController: UITextFieldDelegate {
...
extension SignUpPNTwoViewController: FPNTextFieldDelegate {
...
extension SignUpPNTwoViewController: ASAuthorizationControllerDelegate, ASAuthorizationControllerPresentationContextProviding {
