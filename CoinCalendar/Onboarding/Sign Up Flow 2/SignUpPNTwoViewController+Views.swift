//
//  SignUpPNTwoViewController+Views.swift
//  CoinCalendar
//
...
extension SignUpPNTwoViewController {
    ...
    func setupTransitionViews() {
        ...
        getStartedButton.layer.cornerRadius = 77/2
        ...
        getStartedHeight = getStartedButton.heightAnchor.constraint(equalToConstant: 77)
        getStartedHeight.isActive = true
    ...
    func setupViews() {
        ...
        backDismissButton.isHidden = true
        ...
        signUpTitleLabel.text = "Create Account"
        ...
        //signUpTitleLabel.topAnchor.constraint(equalTo: mainContainer.topAnchor, constant: backTop).isActive = true
...
//        }
        ...
        continueButton.layer.cornerRadius = 77/2
        ...
        continueHeight = continueButton.heightAnchor.constraint(equalToConstant: 77)
